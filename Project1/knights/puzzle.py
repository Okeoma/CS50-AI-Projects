...
"""
Knowledge Base: A character can either be a Knight or a Knave but cannot be both.
A Knight will always tell the truth while a Knave will always tell a lie.
"""
knowledgeBase = And(
    Or(AKnight, AKnave),
